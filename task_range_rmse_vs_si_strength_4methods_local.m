% =========================================================================
% task_range_rmse_vs_si_strength_4methods_local.m
% -------------------------------------------------------------------------
...
% 冒烟模式 (约 5 分钟): task_range_rmse_vs_si_strength_4methods_local(true)
%
% 运行 (在项目根目录):
%   matlab -batch "task_range_rmse_vs_si_strength_4methods_local"         % 正常
%   matlab -batch "task_range_rmse_vs_si_strength_4methods_local(true)"   % 冒烟
%
% 输出 (均在项目根目录):
...
% -------------------------------------------------------------------------
% =========================================================================
function task_range_rmse_vs_si_strength_4methods_local(smoke_test)
...
if ~isunix
    ...
    if isfile(toast_script)
        try
            cmd = sprintf('python "%s" "RMSE-SI强度四方法(本地)" "%d方法x%d点x%dMC, %.1fmin"', ...
