...
%   每个 MC 重新生成发射波形。
% =========================================================================
function task_si_suppression_zf_only()
t_all = tic;
warning('off','all');

log_path = fullfile(pwd, 'task_si_suppression_zf_only.log');
...
save(fullfile(pwd, 'task_si_suppression_zf_only.mat'), ...
...
for fi = 1:3
    ...
    base = fullfile(fig_dir, sprintf('fig_si_suppression_zf_only_%s', fnames{fi}));
