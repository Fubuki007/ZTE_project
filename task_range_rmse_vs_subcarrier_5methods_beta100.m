% =========================================================================
% task_range_rmse_vs_subcarrier_5methods_beta100.m
% -------------------------------------------------------------------------
...
%
% 快速看趋势请用 smoke 版脚本
% 本脚本为服务器全量版: MC=100, Ns=[1024 2048 3168 6336 12672]
%
% 输出:
%   task_range_rmse_vs_subcarrier_5methods_beta100.mat (+checkpoint)
%   data_range_rmse_vs_subcarrier_5methods_beta100.csv
%   fig/fig_range_rmse_vs_subcarrier_5methods_beta100.fig/.png/.eps (主图)
%   fig/fig_angle_rmse_vs_subcarrier_5methods_beta100_bonus.fig/.png/.eps (附赠角度图)
% =========================================================================
clear; close all; clc;
warning('off','all');
t_all = tic;
...
% ======================= 0. 日志 =========================================
log_path = fullfile(pwd, 'task_range_rmse_vs_subcarrier_5methods_beta100_run.log');
if isfile(log_path), delete(log_path); end
diary(log_path);
diary on;

fprintf('============================================================\n');
fprintf('  task_range_rmse_vs_subcarrier_5methods_beta100\n');
...
ckpt_path = fullfile(pwd, 'task_range_rmse_vs_subcarrier_5methods_beta100_checkpoint.mat');
    ...
    for mi = 1:n_methods
        ...
        for mc_i = 1:n_mc
            ...
            try
                ...
                if isfield(cmp, 'rmse_R') && ~isnan(cmp.rmse_R), rr(mc_i) = cmp.rmse_R; end
                if isfield(cmp, 'rmse_theta') && ~isnan(cmp.rmse_theta), tt(mc_i) = cmp.rmse_theta; end
                clear cmp;
            catch ME
...
csv_path = fullfile(pwd, 'data_range_rmse_vs_subcarrier_5methods_beta100.csv');
...
mat_path = fullfile(pwd, 'task_range_rmse_vs_subcarrier_5methods_beta100.mat');
...
local_plot_sweep( ...
    ...
    'fig_range_rmse_vs_subcarrier_5methods_beta100', ...
...
local_plot_sweep( ...
    ...
    'fig_angle_rmse_vs_subcarrier_5methods_beta100_bonus', ...
