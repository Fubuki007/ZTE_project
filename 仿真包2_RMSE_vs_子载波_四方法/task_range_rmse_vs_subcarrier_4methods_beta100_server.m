% =========================================================================
% task_range_rmse_vs_subcarrier_4methods_beta100_server.m
% -------------------------------------------------------------------------
...
% 冒烟模式 (约 3 分钟): task_range_rmse_vs_subcarrier_4methods_beta100_server(true)
%
% 运行 (在项目根目录):
%   matlab -batch "task_range_rmse_vs_subcarrier_4methods_beta100_server"         % 正常
%   matlab -batch "task_range_rmse_vs_subcarrier_4methods_beta100_server(true)"   % 冒烟
%
% 输出 (均在项目根目录):
...
% -------------------------------------------------------------------------
% =========================================================================
function task_range_rmse_vs_subcarrier_4methods_beta100_server(smoke_test)
...
if ~isunix
    ...
    if isfile(toast_script)
        try
            cmd = sprintf('python "%s" "RMSE-子载波四方法(服务器)" "%d方法x%d点x%dMC, %.1fmin"', ...
